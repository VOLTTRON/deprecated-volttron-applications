...
class HASSClimateAgent(Agent):
    ...
    def __init__(self, config_path, **kwargs):
        '''
            Initializes the HASS Climate Agent for communicating with HASS API
            regarding climate components
        '''
        
        super(HASSClimateAgent, self).__init__(**kwargs)
    ...
    def on_publish_topic(self):
        '''
            Publishes the information about climate components loaded on HASS API
        '''
